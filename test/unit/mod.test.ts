...
Deno.test("assign_subtasks - assigns subtasks successfully", async () => {
  ...
  const subtasks = JSON.stringify([
    { id: "sub_1", title: "Task 1", description: "Desc 1", dependencies: [], status: "pending", priority: "high" },
    { id: "sub_2", title: "Task 2", description: "Desc 2", dependencies: ["sub_1"], status: "pending", priority: "medium" },
  ]);
...
Deno.test("assign_subtasks - assigns with agent list", async () => {
  ...
  const subtasks = JSON.stringify([
    { id: "sub_1", title: "Task 1", description: "Desc", dependencies: [], status: "pending", priority: "high" },
  ]);
